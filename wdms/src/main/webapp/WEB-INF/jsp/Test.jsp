                ...
                <form method='POST' id='fileFrom' onsubmit="return false;"> 
                    <div class="row">
                        ...
                        <div class='col-lg-12 col-sm-12 col-md-12 col-xs-12'>
                            ...
                            <input type='text' value="api/Utility/SyncData" id='api' class='form-control'/>
                        ...
                        <div class='col-lg-12 col-sm-12 col-md-12 col-xs-12'>
                            ...
                            <input type='text' id='token' value="Bearer eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxIiwiaXNzIjoiMSwyIiwicm9sZXMiOiJ1c2VyIiwiaWF0IjoxNjA4MzczOTc4LCJleHAiOjE2MDg0NjAzNzh9.H1Tup_pM3F-qmsF70iX-YyIikbDkz1pPIE0QDHfLJ98" class='form-control'/>
