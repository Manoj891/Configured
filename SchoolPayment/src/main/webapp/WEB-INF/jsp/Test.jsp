...
<html lang="en">
                ...
                <form method='POST' id='fileFrom' onsubmit="return false;"> 
                    <div class="row">
                        ...
                        <div class='col-lg-12 col-sm-12 col-md-12 col-xs-12'>
                            <label>API</label>
                            <!--<input type='text' value="" id='api' class='form-control'/>-->

                            <input type='text' value="api/Utility/DueBalance?regNo=2246&schoolCode=001&year=&month=" id='api' class='form-control'/>

                        </div>
                        <div class='col-lg-12 col-sm-12 col-md-12 col-xs-12'>
                            <label>Token</label>
                            <!--<input type='text' id='token' value="" class='form-control'/>-->

                            <input type='text' id='token' value="Bearer eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxIiwiaXNzIjoiS2hhbHRpIiwiYXVkIjoia2hhbHRpQGdtYWlsLmNvbSIsInJvbGVzIjoidXNlciIsImlhdCI6MTU4NTY0OTkxOSwiZXhwIjoxNzQzMzI5OTE5fQ.h5vCK3CrM9MnQFqGv_tWuwvSgO-CB4caYddjfbotaxs" class='form-control'/>
                        ...
                        <div class='col-lg-12 col-sm-12 col-md-12 col-xs-12'>
                            <textarea id="data"  class="form-control" rows="10">
                                <%
                                    String ss = String.valueOf(Math.random());
                                %>
       {
	"regNo": 2246,
	"schoolCode": "001",
	...
	"month": "01",
	"payAmount": "10",
        "ReferenceID": "2246-<%= ss.substring(3, 10)%>"
}
