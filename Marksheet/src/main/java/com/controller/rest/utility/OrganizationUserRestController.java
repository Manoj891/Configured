...
import com.services.utility.OrganizationUserServices;
...
public class OrganizationUserRestController {
    ...
    @Autowired
    OrganizationUserServices service;
    ...
    @PostMapping
    public ResponseEntity doSave(@RequestBody OrganizationUser obj,HttpServletRequest request, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
        return service.save(obj,request, Authorization);
    }

    @PutMapping("/{id}")
    public ResponseEntity doUpdate(@RequestBody OrganizationUser obj, @PathVariable Long id,HttpServletRequest request, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
