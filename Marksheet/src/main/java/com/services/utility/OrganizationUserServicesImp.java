...
@Service
public class OrganizationUserServicesImp implements OrganizationUserServices {
    ...
    public ResponseEntity save(OrganizationUser obj, HttpServletRequest request, String Authorization) {
        ...
        try {
            ...
            repository.save(obj);
            repository.updatePassword(obj.getLoginPass(), obj.getLoginId());
