...
<tr><th hidden>Id</th><th hidden>School</th><th>Reg No</th><th>Student Name</th><th>Dob</th><th>Symbol No</th><th>Grade</th><th>Gpa</th><th>Date Of Issue</th><th hidden>Enter By</th><th hidden>Enter Date</th><th hidden></th><th>SN</th><th></th><th style='width: 90px;'>Action</th></tr></thead><tbody></tbody></table>`;
                var tableData;
...
<td>` + (i + 1) + `</td>
 <td> <a title='Print' href='` + path + `/Utility/MarksheetPrint?id=` + data[i].id + `'  target="_balnk" >Print</a></td>
            <td>
  <a title='Edit' target="_blank" class='glyphicon glyphicon-edit' href='MarkEntryEdit?id=` + data[i].id + `'>Edit</a> 
